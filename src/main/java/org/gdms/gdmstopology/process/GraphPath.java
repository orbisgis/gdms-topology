...
public class GraphPath extends GraphAnalysis {
        ...
        /**
         * Find the shortest path between two nodes using the Dijkstra
         * algorithm. It returns a list of {@link GraphEdge}s.
         *
         * @param dsf
         * @param graph
         * @param startNode
        ...
        /**
         * Find the shortest path between two nodes using the Dijkstra
         * algorithm. The list of {@link GraphEdge}s is stored in a datasource.
         *
         * @param dsf
         * @param graph
         * @param startNode
         ...
         *
         * <p> A radius can be used to constrain the analysis of the graph. The
         * list of {@link GraphEdge}s is stored in a datasource. For each path,
         * the method returns all the geometries of the input graph datasource.
         *
        ...
        /**
         * Compute all shortest distances between one node. The distances are
        ...
        /**
         * Compute all shortest distancs between one node. A radius can be used
         * to constrain the analysis of the graph. The distances are stored in a
         * datasource.
         *
         * @param dsf
         * @param graph
         ...
         * algorithm. A radius can be used to constrain the analysis of the
         * graph. A datasource that contains all destinations must be used
         * following the schema : id :: int, source::int, target::int. The
         * algorithm iters all paths (source, target) and returns the results in
         * a datasource. Duplicate paths (ie rows with the same source and
         * target values) are computed once again.
         *
         * @param dsf
         * @param graph
         * @param nodes
        ...
        /**
         * Return as set of geometries that represent the shortest path between
         * two nodes.
         *
         * @param dsf
         * @param dataSet
         ...
         * dataset that contains all nodes must following the schema : id (int
         * or long), source (int or long) ,target(int or long)
         *
         * @param dsf
         * @param dataSet
         * @param nodes
